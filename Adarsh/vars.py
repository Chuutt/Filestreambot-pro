...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN', "5473067352:AAFc48yTEINRxr2aSLRK1_ZSuhOAsYfMY9k"))
    name = str(getenv('name', 'filetolinkbot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', "-1001793896609"))
    ...
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', "Fuvkrr"))
    if 'DYNO' in environ:
        ON_HEROKU = True
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', "codexun")
